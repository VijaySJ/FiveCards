...
def join_keyboard(web_app_url: str = "https://fivecards-live-production.up.railway.app") -> InlineKeyboardMarkup:
    """Build the keyboard shown when a new game is created.
    
    Provides buttons to join via Telegram or redirect to the Web App.
    """
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("🎮 Play on Telegram", callback_data="action:join")],
        [InlineKeyboardButton("🌐 Play on Web", url=web_app_url)]
    ])
